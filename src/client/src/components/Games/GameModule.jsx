  ...
  render() {
    return (
      <div
        ...
        className="bg-gray-700 text-indigo-400 items-center h-40 w-40 rounded-md m-2 mx-4 w-1/4 flex items-center justify-center flex-wrap cursor-pointer border border-gray-700 hover:bg-gray-600 hover:border-white hover:border-gray-500 hover:border-solid transition duration-150 ease-in-out transform hover:-translate-y-1 hover:scale-105"
      >
